import type {
  OpenhomieBehaviorConfig,
  OpenhomieConfig,
  OpenhomieEngineConfig,
  OpenhomieMemoryConfig,
...
export const DEFAULT_BEHAVIOR: OpenhomieBehaviorConfig = {
  sleep: {
    enabled: true,
...
export const DEFAULT_ENGINE: OpenhomieEngineConfig = {
  limiter: {
    capacity: 3,
    refillPerSecond: 1,
  },
...
export const DEFAULT_MEMORY: OpenhomieMemoryConfig = {
  enabled: true,
...
export const DEFAULT_TOOLS: OpenhomieToolsConfig = {
  restricted: {
