...
import type { OpenhomieConfig, OpenhomieProvider } from './types.js';
...
interface OpenhomieEnv extends NodeJS.ProcessEnv {
...
const assertConfigNumericBounds = (config: OpenhomieConfig): void => {
