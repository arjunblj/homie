export const getInterviewPrompts = (params: {
  ...
  const system = [
    ...
    'You must extract the core of who they are, how they talk, and what they believe.',
    '',
    ...
    '10) what they never say / anti-patterns (e.g. "delve", "as an AI", "great question", "so basically")',
    '',
